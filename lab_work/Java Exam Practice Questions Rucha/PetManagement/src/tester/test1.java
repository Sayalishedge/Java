...
public class test1 {
	public static void main(String[] args) {
		...
		HashMap<Integer, Pet> pets = populateMap(populatePetList());
			...
			try {
				...
				case 2:
					if(adminAuthenticated == true) {
						...
						int id2 = sc.nextInt();
						System.out.println("Enter name, Category, UnitPrice");
						Pet p = new Pet(sc.next(), Category.valueOf(sc.next()), sc.nextInt());
						pets.put(id2, p);
