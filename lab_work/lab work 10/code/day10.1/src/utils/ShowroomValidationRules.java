...
//add a public static method to validate --
	...
	public static void checkForDup(String newChNo, Vehicle[] vehicles) throws InvalidInputException {
	...
	public static Vehicle validateAllInputs(String chasisNo, String vehicleColor,
			double basePrice, String manufactureDate, String company,Vehicle[] showroom) throws InvalidInputException
	{
